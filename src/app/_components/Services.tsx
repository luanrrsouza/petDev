...
function Services() {
  const [emblaRef, emblaApi] = useEmblaCarousel({
    ...
    slidesToScroll: 1,
    breakpoints: {
      "(min-width: 48rem )": { slidesToScroll: 3 },
    },
  });
      ...
      <div className="container mx-auto px-4">
        <div>
          ...
          <div className="relative">
                    ...
                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                      <div className="flex-1 flex items-start justify-between">
                        <div className="flex gap-3">
                          ...
                          <div>
                            <h3 className="text-xl font-bold mb-1 my-1">
                              {item.title}
                            </h3>
            ...
            <button
              onClick={scrollNext}
              className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-2 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10"
            >
